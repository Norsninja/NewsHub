...
def generate_newsletter(top_articles_by_category: Dict[str, List[Tuple]]) -> str:
        ...
        <div style="text-align: center; background-color: #3da0ae; color: #ffffff; padding: 10px; border-radius: 5px;">
            <h2 style="margin: 0;">Daily Briefing - Nov 12, 2023 - NewsPlanetAi</h2>
            <a href="https://on.soundcloud.com/H4mpM" target="_blank" style="color: #ffffff; text-decoration: none; display: inline-block; margin-top: 10px; padding: 10px 20px; background-color: #ffffff; color: #3da0ae; border-radius: 20px;">Listen on SoundCloud</a>
        </div>
